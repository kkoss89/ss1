                            ...
                            <li class="right-nav-list">
                                <div class="dropdown theme-form-select">
                                    <button class="btn dropdown-toggle" type="button" id="select-language"
                                        ...
                                        <img src="<?= BASE ?>themes/moka/assets/images/country/united-states.png"
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0)" id="english">
                                                <img src="<?= BASE ?>themes/moka/assets/images/country/united-kingdom.png"
                                                    class="img-fluid blur-up lazyload" alt="">
                                                <span>English</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0)" id="france">
                                                <img src="<?= BASE ?>themes/moka/assets/images/country/germany.png"
                                                    class="img-fluid blur-up lazyload" alt="">
                                                <span>Germany</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0)" id="chinese">
                                                <img src="<?= BASE ?>themes/moka/assets/images/country/turkish.png"
                                                    class="img-fluid blur-up lazyload" alt="">
                                                <span>Turki</span>
                                            </a>
                                        </li>
                    ...
                    <div class="col-12">
                        <div class="navbar-top">
                            ...
                            <a href="index.html" class="web-logo nav-logo">
                                <img src="<?= BASE ?>themes/moka/assets/images/logo/1.png" class="img-fluid blur-up lazyload" alt="">
                            </a>
                                            ...
                                            <div class="onhover-div">
                                                <ul class="cart-list">
                                                    <li class="product-box-contain">
                                                        <div class="drop-cart">
                                                            <a href="product-left-thumbnail.html" class="drop-image">
                                                                <img src="<?= BASE ?>themes/moka/assets/images/vegetable/product/1.png"
                                                    ...
                                                    <li class="product-box-contain">
                                                        <div class="drop-cart">
                                                            <a href="product-left-thumbnail.html" class="drop-image">
                                                                <img src="<?= BASE ?>themes/moka/assets/images/vegetable/product/2.png"
                                                                    class="blur-up lazyload" alt="">
                                                            </a>
                ...
                <div class="col-12">
                                ...
                                <ul class="category-list">
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="<?= BASE ?>themes/moka/assets/svg/1/vegetable.svg" alt="">
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="<?= BASE ?>themes/moka/assets/svg/1/cup.svg" alt="">
                                            <h6>Beverages</h6>
                                            <i class="fa-solid fa-angle-right"></i>
                                        </a>
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="<?= BASE ?>themes/moka/assets/svg/1/meats.svg" alt="">
                                            <h6>Meats & Seafood</h6>
                                            <i class="fa-solid fa-angle-right"></i>
                                        </a>
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="<?= BASE ?>themes/moka/assets/svg/1/breakfast.svg" alt="">
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="<?= BASE ?>themes/moka/assets/svg/1/frozen.svg" alt="">
                                            <h6>Frozen Foods</h6>
                                            <i class="fa-solid fa-angle-right"></i>
                                        </a>
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="<?= BASE ?>themes/moka/assets/svg/1/biscuit.svg" alt="">
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="<?= BASE ?>themes/moka/assets/svg/1/grocery.svg" alt="">
                                                            ...
                                                            <div class="dropdown-column m-0">
                                                                <div class="menu-img-banner">
                                                                    <a class="text-title" href="product-circle.html">
                                                                        <img src="<?= BASE ?>themes/moka/assets/images/mega-menu.png"
                                                                            alt="banner">
                                                                    </a>
                                                                </div>
                                                            </div>
					...
					<?php if (get_option("enable_service_list_no_login") == 1) {?>
                        <div class="header-nav-right">
                            <button class="btn deal-button" data-bs-toggle="modal" data-bs-target="#deal-box">
                                <i data-feather="zap"></i>
                                <span><a class="nav-link" href="<?=cn("services")?>"><?=lang("Services")?></a></span>
                            </button>
                        </div>						
					<?php }?>		
                    </div>
                            ...
                            <ul class="nav nav-pills mb-3 custom-nav-tab" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="pills-vegetables" data-bs-toggle="pill"
                                        ...
                                        <img src="<?= BASE ?>themes/moka/assets/svg/1/vegetable.svg" class="blur-up lazyload"
                                            alt=""></button>
                                </li>
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-beverages" data-bs-toggle="pill"
                                        data-bs-target="#pills-beverages" type="button" role="tab">Beverages <img
                                            src="<?= BASE ?>themes/moka/assets/svg/1/cup.svg" class="blur-up lazyload" alt=""></button>
                                </li>

                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-meat" data-bs-toggle="pill"
                                        data-bs-target="#pills-meat" type="button" role="tab">Meats & Seafood <img
                                            src="<?= BASE ?>themes/moka/assets/svg/1/meats.svg" alt="" class="blur-up lazyload"></button>
                                </li>
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-dairy" data-bs-toggle="pill"
                                        data-bs-target="#pills-dairy" type="button" role="tab">Breakfast & Dairy <img
                                            src="<?= BASE ?>themes/moka/assets/svg/1/breakfast.svg" class="blur-up lazyload"
                                            alt=""></button>
                                </li>
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-frozen" data-bs-toggle="pill"
                                        data-bs-target="#pills-frozen" type="button" role="tab">Frozen Foods <img
                                            src="<?= BASE ?>themes/moka/assets/svg/1/frozen.svg" class="blur-up lazyload" alt=""></button>
                                </li>
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-snack" data-bs-toggle="pill"
                                        data-bs-target="#pills-snack" type="button" role="tab">Biscuits & Snacks <img
                                            src="<?= BASE ?>themes/moka/assets/svg/1/biscuit.svg" class="blur-up lazyload" alt=""></button>
                                </li>
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-grocery" data-bs-toggle="pill"
                                        data-bs-target="#pills-grocery" type="button" role="tab">Grocery & Staples <img
                                            src="<?= BASE ?>themes/moka/assets/svg/1/grocery.svg" class="blur-up lazyload" alt=""></button>
                                </li>
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-wines" data-bs-toggle="pill"
                                        ...
                                        <img src="<?= BASE ?>themes/moka/assets/svg/1/drink.svg" class="blur-up lazyload" alt=""></button>
                                </li>

                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-milk" data-bs-toggle="pill"
                                        data-bs-target="#pills-milk" type="button" role="tab">Milk & Dairies <img
                                            src="<?= BASE ?>themes/moka/assets/svg/1/milk.svg" alt="" class="blur-up lazyload"></button>
                                </li>

                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-pet" data-bs-toggle="pill"
                                        data-bs-target="#pills-pet" type="button" role="tab">Pet Foods <img
                                            class="blur-up lazyload" src="<?= BASE ?>themes/moka/assets/svg/1/pet.svg" alt=""></button>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="top-filter-menu">
                            ...
                            <div class="grid-option d-none d-md-block">
                                <ul>
                                    <li class="three-grid">
                                        <a href="javascript:void(0)">
                                            <img src="<?= BASE ?>themes/moka/assets/svg/grid-3.svg" class="blur-up lazyload" alt="">
                                        </a>
                                    </li>
                                    <li class="grid-btn d-xxl-inline-block d-none active">
                                        <a href="javascript:void(0)">
                                            <img src="<?= BASE ?>themes/moka/assets/svg/grid-4.svg"
                                                class="blur-up lazyload d-lg-inline-block d-none" alt="">
                                            <img src="<?= BASE ?>themes/moka/assets/svg/grid.svg"
                                                class="blur-up lazyload img-fluid d-lg-none d-inline-block" alt="">
                                        </a>
                                    </li>
                                    <li class="list-btn">
                                        <a href="javascript:void(0)">
                                            <img src="<?= BASE ?>themes/moka/assets/svg/list.svg" class="blur-up lazyload" alt="">
                                        </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="product-box-3 h-100 wow fadeInUp">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="<?= BASE ?>themes/moka/assets/images/cake/product/2.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 h-100 wow fadeInUp" data-wow-delay="0.05s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="<?= BASE ?>themes/moka/assets/images/cake/product/3.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 h-100 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="<?= BASE ?>themes/moka/assets/images/cake/product/4.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 h-100 wow fadeInUp" data-wow-delay="0.15s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="<?= BASE ?>themes/moka/assets/images/cake/product/5.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 h-100 wow fadeInUp" data-wow-delay="0.2s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="<?= BASE ?>themes/moka/assets/images/cake/product/6.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 h-100 wow fadeInUp" data-wow-delay="0.25s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="<?= BASE ?>themes/moka/assets/images/cake/product/7.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
        ...
        <div class="container-fluid-lg">
                        ...
                        <div class="service-contain">
                            <div class="service-box">
                                <div class="service-image">
                                    <img src="<?= BASE ?>themes/moka/assets/svg/product.svg" class="blur-up lazyload" alt="">
                                </div>
                            ...
                            <div class="service-box">
                                <div class="service-image">
                                    <img src="<?= BASE ?>themes/moka/assets/svg/delivery.svg" class="blur-up lazyload" alt="">
                                </div>
                            ...
                            <div class="service-box">
                                <div class="service-image">
                                    <img src="<?= BASE ?>themes/moka/assets/svg/discount.svg" class="blur-up lazyload" alt="">
                                </div>
                            ...
                            <div class="service-box">
                                <div class="service-image">
                                    <img src="<?= BASE ?>themes/moka/assets/svg/market.svg" class="blur-up lazyload" alt="">
                                </div>
            ...
            <div class="main-footer section-b-space section-t-space">
                <div class="row g-md-4 g-3">
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="footer-logo">
                            <div class="theme-logo">
                                <a href="index.html">
                                    <img src="<?= BASE ?>themes/moka/assets/images/logo/1.png" class="blur-up lazyload" alt="">
                                </a>
                            </div>

                            <div class="footer-logo-contain">
                                <p><?php echo lang("footer_slogan"); ?></p>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="footer-title">
                            <h4><?=lang("contact_informations")?></h4>
                        </div>
                                ...
                                <li>
                                    <div class="footer-number">
                                        ...
                                        <div class="contact-number">
                                            <h6 class="text-content">Support 24/7 :</h6>
                                            <h5><a href="https://api.whatsapp.com/send?phone=<?=get_option('contact_tel',"+12345678")?>"><?=get_option('contact_tel',"+12345678")?></a></h5>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="footer-number">
                                        ...
                                        <div class="contact-number">
                                            ...
                                            <h5><a href="mailto:<?=get_option('contact_email',"do-not-reply@smartpanel.com")?>"><?=get_option('contact_email',"do-not-reply@smartpanel.com")?> </a></h5>
                                        </div>
                                    </div>
                                </li>
                               <li>
                                    <div class="footer-number">
                                        ...
                                        <div class="contact-number">
                                            <h6 class="text-content">Telegram :</h6>
                                            <h5><a href="https://t.me/<?=lang("telegram")?>">@<?=lang("telegram")?></a></h5>
                                        </div>
                                    </div>
                                </li>
                            </ul>
            ...
            <div class="sub-footer section-small-space">
                <div class="reserve">
                    <h6 class="text-content"><?=get_option('copy_right_content',"Copyright &copy; 2020 - SmartPanel");?> <?=(get_role("admin")) ? $version : "" ?></h6>
                </div>
                <div class="payment">
                    <img src="<?= BASE ?>themes/moka/assets/images/payment/1.png" class="blur-up lazyload" alt="">
                </div>
                <div class="social-link">
                    ...
                    <ul>
                        <li>
                            <a href="<?=get_option('social_facebook_link','https://facebook.com')?>" target="_blank">
                                <i class="fa-brands fa-facebook-f"></i>
                            </a>
                        </li>
                        <li>
                            <a href="<?=get_option('social_twitter_link','https://twitter.com')?>" target="_blank">
                                <i class="fa-brands fa-twitter"></i>
                            </a>
                        </li>
                        <li>
                            <a href="<?=get_option('social_instagram_link','https://instagram.com')?>" target="_blank">
                                <i class="fa-brands fa-instagram"></i>
                            </a>
                        </li>
                        <li>
                            <a href="<?=get_option('social_youtube_link','https://youtube.com')?>" target="_blank">
                    ...
                    <div class="row g-sm-4 g-2">
                        <div class="col-lg-6">
                            <div class="slider-image">
                                <img src="<?= BASE ?>themes/moka/assets/images/product/category/1.jpg" class="img-fluid blur-up lazyload"
                                    alt="">
                            </div>
                        </div>
                    ...
                    <div class="deal-offer-box">
                        <ul class="deal-offer-list">
                            <li class="list-1">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="<?= BASE ?>themes/moka/assets/images/vegetable/product/10.png" class="blur-up lazyload"
                                            alt="">
                                    </a>
                            ...
                            <li class="list-2">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="<?= BASE ?>themes/moka/assets/images/vegetable/product/11.png" class="blur-up lazyload"
                                            alt="">
                                    </a>
                            ...
                            <li class="list-3">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="<?= BASE ?>themes/moka/assets/images/vegetable/product/12.png" class="blur-up lazyload"
                                            alt="">
                                    </a>
                            ...
                            <li class="list-1">
                                <div class="deal-offer-contain">
                                    <a href="shop-left-sidebar.html" class="deal-image">
                                        <img src="<?= BASE ?>themes/moka/assets/images/vegetable/product/13.png" class="blur-up lazyload"
                                            alt="">
                                    </a>
    ...
    <div class="add-cart-box">
        <div class="add-image">
            <img src="<?= BASE ?>themes/moka/assets/images/cake/pro/1.jpg" class="img-fluid blur-up lazyload" alt="">
        </div>
