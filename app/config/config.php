...
if (stripos($_SERVER["REQUEST_URI"], 'nowpayments_ipn') !== false) {
    $config['csrf_protection'] = false;
}

if (stripos($_SERVER["REQUEST_URI"], 'add_funds/nowpayments/create_payment') !== false) {
    $config['csrf_protection'] = false;
}
...
if (stripos($_SERVER["REQUEST_URI"], 'add_funds/cryptomus/create_payment') !== false) {
    $config['csrf_protection'] = false;
}
if (stripos($_SERVER["REQUEST_URI"], 'add_funds/cryptomus/complete') !== false) {
    $config['csrf_protection'] = false;
}
if (stripos($_SERVER["REQUEST_URI"], 'add_funds/cryptomus/callback') !== false) {
    $config['csrf_protection'] = false;
}
if (stripos($_SERVER["REQUEST_URI"], 'add_funds/cryptomus/cancel') !== false) {
    $config['csrf_protection'] = false;
}
if (stripos($_SERVER["REQUEST_URI"], 'add_funds/crypto/complete') !== false) {
    $config['csrf_protection'] = false;
}
if (stripos($_SERVER["REQUEST_URI"], 'add_funds/crypto/callback') !== false) {
    $config['csrf_protection'] = false;
}
...
*/
$config['proxy_ips'] = '185.178.51.131,185.178.51.132,159.69.32.151'; 
