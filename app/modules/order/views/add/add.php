                ...
                <div class="tab-content">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group" id="result_total_charge">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-min-width mr-1 mb-1 total_charge w-100"><?= lang("place_order") ?> | <span class="charge_number">$0</span></button>
                                    ...
                                    <div class="form-actions left">
                                        <button type="submit" class="btn btn-primary btn-min-width mr-1 mb-1"><?= lang("place_order") ?> | <span class="charge_number">$0</span></button>
                                    </div>
                                    -->
                                </div>
                    ...
                    <div id="mass_order" class="tab-pane fade">
                        <form class="form actionForm" action="<?= cn($controller_name . "/ajax_mass_order") ?>" data-redirect="<?= cn($controller_name) ?>" method="POST">
							<input type="hidden" name="mass_service_price" id="mass_service_price">
							<input type="hidden" name="mass_service_min" id="mass_service_min">
							<input type="hidden" name="mass_service_max" id="mass_service_max">
							<input type="hidden" name="mass_total_charge" value="0.00">
                            ...
                            <div class="x_content row">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
									<div class="form-group">
                                        <label><?= lang("Category") ?></label>
                                        <select name="mass_category_id" class="form-control square ajaxMassChangeCategory" data-url="<?= cn($controller_name . "/get_mass_services/") ?>" required>
								...
								<div class="col-md-6 col-sm-12 col-xs-12">
									 <div class="form-group" id="result_onMassChange">
                                        <label><?= lang("order_service") ?></label>
                                        <select name="mass_service_id" class="form-control square ajaxMassChangeService" data-url="<?= cn($controller_name . "/get_mass_service/") ?>" required>
                                            <option value=""> <?= lang("choose_a_service") ?></option>
                                        </select>
                                    </div>
								</div>
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div class="form-group">
										<textarea id="editor" rows="5" name="mass_order" class="form-control square mass_order_links" placeholder="https://link1.com&#10;https://link2.com&#10;...&#10;https://linkn.com"></textarea>
									</div>
								</div>
								<div class="col-md-4 col-sm-12 col-xs-12">
									<div class="form-group order-default-quantity">
                                        <label><?= lang("Quantity") ?></label>
                                        <input class="form-control square ajaxMassQuantity" name="mass_quantity" type="number" required>
                                    </div>
								</div>
								<div class="col-md-4 col-sm-12 col-xs-12">
									<div class="form-group order-default-quantity">
                                        <label><?= lang("Minimum Quantity") ?></label>
                                        <input class="form-control square ajaxMassMinQuantity" name="mass_min_quantity" type="number" readonly>
                                    </div>
								</div>
								<div class="col-md-4 col-sm-12 col-xs-12">
									<div class="form-group order-default-quantity">
                                        <label><?= lang("Maximum Quantity") ?></label>
                                        <input class="form-control square ajaxMassMaxQuantity" name="mass_max_quantity" type="number" readonly>
                                    </div>
								</div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
									<div class="form-group">
								...
								<div class="col-md-6 col-sm-12 col-xs-12 mass_service_description_info d-none">	
                                    <div class="mass_order_error" id="result_notification">
                                        <div class="content-header-title">
                                            <h6><i class="fa fa-info-circle"></i> <?= lang("description") ?></h6>
                                        </div>
                                        <div class="form-group mass_service_description">
                            ...
                            <div class="form-actions left">
                                <button type="submit" class="btn round btn-primary btn-min-width mr-1 mb-1">
                                    <?= lang("place_order") ?>  | <span class="mass_charge_number">$0</span>
                                </button>
                            </div>
                        </form>
                    </div>
