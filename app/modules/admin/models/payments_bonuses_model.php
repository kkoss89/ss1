...
class payments_bonuses_model extends MY_Model 
{
    ...
    public function list_items($params = null, $option = null)
    {
        ...
        if ($option['task'] == 'list-items') {
            $this->db->select('pb.id, pb.payment_id, pb.bonus_from, pb.percentage, pb.status, pb.bonus_description, pb.bonus_user_type, pb.user_ids');
        ...
        } elseif ($option['task'] == 'list-items-users') {
    ...
    public function get_item($params = null, $option = null)
    {
        ...
        if($option['task'] == 'get-item'){
            $result = $this->get("id,  payment_id, bonus_from, percentage, status, bonus_description, bonus_user_type, user_ids", $this->tb_main, ['id' => $params['id']], '', '', true);
        }
        return $result;
    }
        ...
        switch ($option['task']) {
            ...
            case 'add-item':
                $data = [
					...
					"bonus_description" => post("bonus_description"),
					"bonus_user_type"   => post("bonus_user_type"),
					"user_ids"          => (!empty(post("user_ids"))) ? implode(",",post("user_ids")) : '',
                ];
