...
class blacklist_link_model extends MY_Model
{
    ...
    public function __construct()
    {
        ...
        $this->field_search_accepted = app_config('config')['search']['blacklist_link'];
    }
    ...
    public function list_items($params = null, $option = null)
    {
        ...
        if ($option['task'] == 'list-items') {
            $this->db->select('id, ids, link, description, created, status');
    ...
    public function get_item($params = null, $option = null)
    {
        ...
        if ($option['task'] == 'get-item') {
            $result = $this->get("id, ids, link, description, status", $this->tb_main, ['ids' => $params['ids']], '', '', true);
        }
