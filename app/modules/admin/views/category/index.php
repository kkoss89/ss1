                                    ...
                                    <tr class="tr_<?php echo esc($item['ids']); ?>" data-id="<?php echo $item['id']; ?>">
                                        ...
                                        <td>
											<div class="title d-flex align-items-center">
												<?php if(strpos($item['image'], 'fa-') === false): ?>
													<i class="mr-1 fa-solid fa-circle"></i>
												<?php else: ?>
													<i class="mr-1 <?php echo show_high_light(esc($item['image']), $params['search'], 'name'); ?>"></i>
												<?php endif; ?>
												<?php echo show_high_light(esc($item['name']), $params['search'], 'name'); ?>
											</div>
										</td>
