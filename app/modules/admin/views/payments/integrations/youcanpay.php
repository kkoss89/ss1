<?php
  ...
  $payment_elements = [
    ...
    [
      ...
      'item2'      => ['name' => @$payment_option->currency_code, 'value' => '10.5'],
    ],
  ];
...
<div class="form-group">
  <div class="form-group">
    ...
    <ol class="small">
      <li> Public key and Private key you may find on <strong>youcanpay.com/settings</strong> > API keys </li>
      <li> Go to <strong>youcanpay.com/settings/webhooks</strong> and click on Add webhook </li>
      <li> Webhook URL: <code><?php echo cn('youcanpay_ipn'); ?></code></li>
