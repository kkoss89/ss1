		...
		<div class="row">
			<div class="col-md-12">
				<div class="for-group text-center">
					<img src="<?=BASE?>/assets/images/cryptomus.png" alt="Cryptomus">
					<p class="p-t-10">
						<small><?=sprintf(lang("you_can_deposit_funds_with_cryptomus_they_will_be_automaticly_added_into_your_account"), 'Cryptomus')?></small>
					</p>
				</div>
				<div class="form-group">
					<label><?=sprintf(lang("amount_usd"), $currency_code)?></label>
					<input class="form-control square" type="number" name="amount" step="0.1" min="<?php echo $min_amount; ?>" max="<?php echo $max_amount; ?>" placeholder="<?php echo $min_amount; ?>" required>
				</div>  
				<div class="form-group">
