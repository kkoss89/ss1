...
<script type="text/javascript" src="<?php echo BASE; ?>assets/js/general.js?v=<?php echo time(); ?>"></script>
<script id="boxcoin" src="https://social.ci/crypto/js/client.js"></script>
